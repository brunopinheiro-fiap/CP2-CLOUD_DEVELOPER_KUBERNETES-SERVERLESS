...
Além disso, foi demonstrada a criação de imagens versionadas, o envio para o Docker Hub e a utilização de boas práticas de containerização

Desenvolvido como parte da avaliação prática de CP2 – CLOUD_DEVELOPER_KUBERNETES-SERVERLESS 💙🐳
```
